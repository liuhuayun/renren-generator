...
public class ModelController{
    ...
    R list(int limit,int page) {
    	int[] transToStartEnd = PageUtil.transToStartEnd(page, limit);
        List<Model> list = repositoryService.createModelQuery().listPage(transToStartEnd[0]
                , transToStartEnd[1]);
